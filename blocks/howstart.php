<section class="how-start py-5">
	<div class="container">
		<div class="row text-center">
			<div class="col-md-12">
				<h2 class="text-white font-weight-bold mb-4">Как начать</h2>
		...
		<div class="row">
			<div class="col-md-4 mb-5">
				...
				<div class="circle-text lead text-center">
			...
			<div class="col-md-4 mb-5">
				...
				<div class="circle-text lead text-center">
					Расскажите нам, что Вы хотите. Мы вместе составим Техническое задание. 
				</div>
			</div>
			<div class="col-md-4 mb-5">
				<div class="circle">
				...
				<div class="circle-text lead text-center">
					Показываем макет, если все устраивает, ждем от Вас предоплату и приступаем к работе.  
				</div>
			</div>
		</div>
	</div>
