		...
		<div class="container py-5">
			<div class="row justify-content-center">
				<div class="col-md-10 lead">
					...
					<br><br>
					<a href="<?php bloginfo('template_url'); ?>/img/freeaudit1.png" data-lightbox="image1" data-title="Free-Audit1"><img src="<?php bloginfo('template_url'); ?>/img/freeaudit1.png" alt="" class="shadow-img width100"></a>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-10">
